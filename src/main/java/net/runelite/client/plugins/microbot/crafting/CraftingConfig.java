...
public interface CraftingConfig extends Config {
        ...
        @ConfigSection(name = "Dragon Leather", description = "Configure settings for Dragon Leather activity", position = 4, closedByDefault = true)
        ...
        @ConfigItem(keyName = "Afk", name = "Random AFKs", description = "Randomly afks between 3 and 60 seconds", position = 1, section = generalSection)
        default boolean Afk() {
                return false;
        }
        ...
        @ConfigItem(name = "Armour", description = "Choose type of dragon leather armour", keyName = "dragonLeatherArmour", position = 0, section = dragonLeatherSection)
        default DragonLeatherArmour dragonLeatherType() {
                return DragonLeatherArmour.NONE;
        }

        @ConfigItem(name = "Use Costume Needle", description = "Use costume needle instead of regular needle + thread (saves inventory slot)", keyName = "useCostumeNeedle", position = 1, section = dragonLeatherSection)
        default boolean useCostumeNeedle() {
                return false;
        }

        @ConfigSection(name = "Leather", description = "Configure settings for Leather Crafting activity (F2P)", position = 5, closedByDefault = true)
        String leatherSection = "leather";

        @ConfigItem(name = "Armour", description = "Choose type of leather armour", keyName = "leatherArmour", position = 0, section = leatherSection)
        default LeatherArmour leatherType() {
                return LeatherArmour.NONE;
        }

        @ConfigItem(name = "Use Costume Needle", description = "Use costume needle instead of regular needle + thread", keyName = "useCostumeNeedleLeather", position = 1, section = leatherSection)
        default boolean useCostumeNeedleLeather() {
                return false;
        }
}
